...
#  4. A variable called num_avg has been created indicating the number of readings to average for each measurment.
...
#
print(
    f"Running calibration, OSR = {gizmo.adc_get_osr()}, AZ_MUX = {gizmo.adc_get_azmux()}, and num_avg = {num_avg}..."
)
...
gizmo.adc_slopes[0] = 5.0 / (vrefp - vrefm)
